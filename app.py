...
app.add('/',                    GET=redirect('/en/0.1/index.html'))
app.add('/license/',            GET=redirect('/en/0.1/license.html'))
app.add('/about/',              GET=redirect('/en/0.1/frontmatter.html'))
app.add('/en/0.1/',             GET=redirect('/en/0.1/index.html'))
app.add('/en/0.1/{doc:chunk}/', GET=redirect('/en/0.1/{doc}.html'))
app.add('/en/0.1/{doc:chunk}/', GET=redirect('/en/0.1/{doc}.html'))

# Serve docs at "/en/0.1" still, to leave room for the future.
# One of these days I'll actually do this, not just talk about it!
docs = static.Cling(Path(__file__).parent.child('_build', 'html'))
app.add("/en/0.1|", GET=docs)
